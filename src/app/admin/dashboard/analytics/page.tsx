    ...
    <div className="p-6">
      ...
      {loading ? (
        ...
        <div className="space-y-6">
          ...
          {/* Top Pages */}
          <div className="bg-white dark:bg-gray-800 p-4 rounded-lg shadow">
            <h3 className="text-lg font-semibold mb-3">Most Visited Pages</h3>
            <div className="overflow-x-auto">
              <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                <thead>
                  <tr>
                ...
                <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
                  {analytics.topPages.map((page) => (
                    <tr key={page.path}>
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-sm">
                        {((page._count / analytics.totalPageViews) * 100).toFixed(2)}%
                      </td>
                    </tr>
                  ))}
                </tbody>
          ...
          {/* Top Actions */}
          <div className="bg-white dark:bg-gray-800 p-4 rounded-lg shadow">
            <h3 className="text-lg font-semibold mb-3">Most Common User Actions</h3>
            <div className="overflow-x-auto">
              <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                <thead>
                  <tr>
                ...
                <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
                  {analytics.topActions.map((action) => (
                    <tr key={action.actionType}>
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-sm">
                        {((action._count / analytics.totalActions) * 100).toFixed(2)}%
                      </td>
                    </tr>
                  ))}
                </tbody>
